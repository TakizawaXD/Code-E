    ...
    useEffect(() => {
        ...
        const init = async () => {
            ...
            const contentData = {
                ...
                'part2-sec4': `<h1>Parte II: La Aplicación</h1><h2>Sección 4: Deconstruyendo Problemas: Los Patrones "Grokking"</h2><h3>4.1 Ventana Deslizante (Sliding Window)</h3><p>Este patrón se utiliza para realizar una operación en una subsección contigua de un array o cadena. La ventana se desliza sobre los datos.</p><h4>Ejemplo: Máxima Suma de Subarray de Tamaño K</h4><div class="code-container" data-id="sliding-window-1"></div><h3>4.2 Dos Punteros (Two Pointers)</h3><p>Utiliza dos punteros que se mueven a través de una estructura de datos (generalmente un array ordenado).</p><h4>Ejemplo: Par con Suma Objetivo</h4><div class="code-container" data-id="two-pointers-1"></div><h3>4.3 Punteros Rápidos y Lentos (Fast & Slow Pointers)</h3><p>También conocido como el algoritmo de la liebre y la tortuga, este patrón utiliza dos punteros que se mueven a diferentes velocidades.</p><h4>Ejemplo: Detección de Ciclo en Lista Enlazada</h4><div class="code-container" data-id="fast-slow-1"></div><h3>4.4 Fusión de Intervalos (Merge Intervals)</h3><p>Este patrón se ocupa de problemas que involucran intervalos superpuestos.</p><h4>Ejemplo: Fusionar Intervalos</h4><div class="code-container" data-id="merge-intervals-1"></div>`,
