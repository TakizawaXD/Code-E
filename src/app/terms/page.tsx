...
export default function TermsPage() {
  return (
    <div className="container mx-auto max-w-4xl py-12">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-3xl">Términos y Condiciones de Kursor</CardTitle>
        </CardHeader>
        <CardContent className="prose dark:prose-invert max-w-none">
          <p>Última actualización: {new Date().toLocaleDateString()}</p>
          
          <h2>1. Aceptación de los Términos</h2>
          <p>Al acceder y utilizar Kursor (en adelante, "la Plataforma"), usted acepta estar sujeto a estos Términos y Condiciones ("Términos"), todas las leyes y regulaciones aplicables, y acepta que es responsable del cumplimiento de las leyes locales aplicables. Si no está de acuerdo con alguno de estos términos, se le prohíbe usar o acceder a este sitio.</p>
          ...
          <p>Esta licencia terminará automáticamente si usted viola alguna de estas restricciones y puede ser terminada por Kursor en cualquier momento.</p>

          <h2>3. Descargo de Responsabilidad</h2>
          <p>Los materiales en la Plataforma se proporcionan "tal cual". Kursor no ofrece garantías, expresas o implícitas, y por la presente renuncia y niega todas las demás garantías, incluidas, entre otras, las garantías implícitas o condiciones de comerciabilidad, idoneidad para un propósito particular o no infracción de la propiedad intelectual u otra violación de derechos.</p>

          <h2>4. Limitaciones</h2>
          <p>En ningún caso Kursor o sus proveedores serán responsables de los daños (incluidos, entre otros, los daños por pérdida de datos o ganancias, o debido a la interrupción del negocio) que surjan del uso o la incapacidad de usar los materiales en la Plataforma, incluso si Kursor o un representante autorizado de Kursor ha sido notificado oralmente o por escrito de la posibilidad de dicho daño.</p>
          ...
          <p>Kursor puede revisar estos Términos en cualquier momento sin previo aviso. Al usar esta Plataforma, usted acepta estar sujeto a la versión actual de estos Términos y Condiciones.</p>
