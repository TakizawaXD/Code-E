...
const courseData: Omit<Course, 'modules'>[] = [
    ...
    { id: 'web-typescript', pathId: 'desarrollo-web', title: 'TypeScript para Desarrollo Frontend', description: 'Añade tipado estático a tus proyectos de JavaScript para construir aplicaciones más robustas. Proyecto Final Sugerido: Refactoriza una aplicación de JavaScript existente (como una To-Do list) a TypeScript, definiendo interfaces y tipos para todos los datos.', instructor: 'Clara Pons', instructorAvatarUrl: 'https://i.pravatar.cc/150?u=clarapons', imageUrl: 'https://images.unsplash.com/photo-1542382257-80dedb725088?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'},
